 ...
 * Reads from `data/company` for now — once Phase 9/11 introduce live
 ...
 *
 * Hides while CEO Mode is active — `ExecutiveAttentionPanel` is the
 * one thing on screen then (spec section 7: "most secondary
